...
func DeployERC721TokenMock(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *types.Transaction, *ERC721TokenMock, error) {
	...
	return address, tx, &ERC721TokenMock{ERC721TokenMockCaller: ERC721TokenMockCaller{contract: contract}, ERC721TokenMockTransactor: ERC721TokenMockTransactor{contract: contract}, ERC721TokenMockFilterer: ERC721TokenMockFilterer{contract: contract}}, nil
}
...
type ERC721TokenMock struct {
	...
	ERC721TokenMockFilterer   // Log filterer for contract events
}
...
// ERC721TokenMockFilterer is an auto generated log filtering Go binding around an Ethereum contract events.
type ERC721TokenMockFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}
...
func NewERC721TokenMock(address common.Address, backend bind.ContractBackend) (*ERC721TokenMock, error) {
	contract, err := bindERC721TokenMock(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &ERC721TokenMock{ERC721TokenMockCaller: ERC721TokenMockCaller{contract: contract}, ERC721TokenMockTransactor: ERC721TokenMockTransactor{contract: contract}, ERC721TokenMockFilterer: ERC721TokenMockFilterer{contract: contract}}, nil
}
...
func NewERC721TokenMockCaller(address common.Address, caller bind.ContractCaller) (*ERC721TokenMockCaller, error) {
	contract, err := bindERC721TokenMock(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
...
func NewERC721TokenMockTransactor(address common.Address, transactor bind.ContractTransactor) (*ERC721TokenMockTransactor, error) {
	contract, err := bindERC721TokenMock(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
...
// NewERC721TokenMockFilterer creates a new log filterer instance of ERC721TokenMock, bound to a specific deployed contract.
func NewERC721TokenMockFilterer(address common.Address, filterer bind.ContractFilterer) (*ERC721TokenMockFilterer, error) {
	contract, err := bindERC721TokenMock(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &ERC721TokenMockFilterer{contract: contract}, nil
}

// bindERC721TokenMock binds a generic wrapper to an already deployed contract.
func bindERC721TokenMock(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(ERC721TokenMockABI))
	if err != nil {
		return nil, err
	}
...
// ERC721TokenMockApprovalIterator is returned from FilterApproval and is used to iterate over the raw logs and unpacked data for Approval events raised by the ERC721TokenMock contract.
type ERC721TokenMockApprovalIterator struct {
	Event *ERC721TokenMockApproval // Event containing the contract specifics and raw log
...
func (it *ERC721TokenMockApprovalIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ERC721TokenMockApproval)
...
func (it *ERC721TokenMockApprovalIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ERC721TokenMockApprovalIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ERC721TokenMockApproval represents a Approval event raised by the ERC721TokenMock contract.
type ERC721TokenMockApproval struct {
...
func (_ERC721TokenMock *ERC721TokenMockFilterer) FilterApproval(opts *bind.FilterOpts, _owner []common.Address, _approved []common.Address) (*ERC721TokenMockApprovalIterator, error) {
	...
	logs, sub, err := _ERC721TokenMock.contract.FilterLogs(opts, "Approval", _ownerRule, _approvedRule)
	if err != nil {
		return nil, err
	}
	return &ERC721TokenMockApprovalIterator{contract: _ERC721TokenMock.contract, event: "Approval", logs: logs, sub: sub}, nil
}

// WatchApproval is a free log subscription operation binding the contract event 0x8c5be1e5ebec7d5bd14f71427d1e84f3dd0314c0f7b2291e5b200ac8c7c3b925.
//
// Solidity: event Approval(_owner indexed address, _approved indexed address, _tokenId uint256)
func (_ERC721TokenMock *ERC721TokenMockFilterer) WatchApproval(opts *bind.WatchOpts, sink chan<- *ERC721TokenMockApproval, _owner []common.Address, _approved []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ERC721TokenMock.contract.WatchLogs(opts, "Approval", _ownerRule, _approvedRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(ERC721TokenMockApproval)
				if err := _ERC721TokenMock.contract.UnpackLog(event, "Approval", log); err != nil {
					return err
				}
				event.Raw = log
...
// ERC721TokenMockTransferIterator is returned from FilterTransfer and is used to iterate over the raw logs and unpacked data for Transfer events raised by the ERC721TokenMock contract.
type ERC721TokenMockTransferIterator struct {
	Event *ERC721TokenMockTransfer // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ERC721TokenMockTransferIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ERC721TokenMockTransfer)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ERC721TokenMockTransferIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ERC721TokenMockTransferIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ERC721TokenMockTransfer represents a Transfer event raised by the ERC721TokenMock contract.
type ERC721TokenMockTransfer struct {
	From    common.Address
	To      common.Address
	TokenId *big.Int
	Raw     types.Log // Blockchain specific contextual infos
...
func (_ERC721TokenMock *ERC721TokenMockFilterer) FilterTransfer(opts *bind.FilterOpts, _from []common.Address, _to []common.Address) (*ERC721TokenMockTransferIterator, error) {
	...
	logs, sub, err := _ERC721TokenMock.contract.FilterLogs(opts, "Transfer", _fromRule, _toRule)
	if err != nil {
		return nil, err
	}
	return &ERC721TokenMockTransferIterator{contract: _ERC721TokenMock.contract, event: "Transfer", logs: logs, sub: sub}, nil
}

// WatchTransfer is a free log subscription operation binding the contract event 0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef.
//
// Solidity: event Transfer(_from indexed address, _to indexed address, _tokenId uint256)
func (_ERC721TokenMock *ERC721TokenMockFilterer) WatchTransfer(opts *bind.WatchOpts, sink chan<- *ERC721TokenMockTransfer, _from []common.Address, _to []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ERC721TokenMock.contract.WatchLogs(opts, "Transfer", _fromRule, _toRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ERC721TokenMockTransfer)
				if err := _ERC721TokenMock.contract.UnpackLog(event, "Transfer", log); err != nil {
					return err
				}
				event.Raw = log
