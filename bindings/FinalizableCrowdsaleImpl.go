...
func DeployFinalizableCrowdsaleImpl(auth *bind.TransactOpts, backend bind.ContractBackend, _startTime *big.Int, _endTime *big.Int, _rate *big.Int, _wallet common.Address) (common.Address, *types.Transaction, *FinalizableCrowdsaleImpl, error) {
	...
	return address, tx, &FinalizableCrowdsaleImpl{FinalizableCrowdsaleImplCaller: FinalizableCrowdsaleImplCaller{contract: contract}, FinalizableCrowdsaleImplTransactor: FinalizableCrowdsaleImplTransactor{contract: contract}}, nil
}
...
func NewFinalizableCrowdsaleImpl(address common.Address, backend bind.ContractBackend) (*FinalizableCrowdsaleImpl, error) {
	contract, err := bindFinalizableCrowdsaleImpl(address, backend, backend)
	if err != nil {
		return nil, err
	}
	return &FinalizableCrowdsaleImpl{FinalizableCrowdsaleImplCaller: FinalizableCrowdsaleImplCaller{contract: contract}, FinalizableCrowdsaleImplTransactor: FinalizableCrowdsaleImplTransactor{contract: contract}}, nil
}
...
func NewFinalizableCrowdsaleImplCaller(address common.Address, caller bind.ContractCaller) (*FinalizableCrowdsaleImplCaller, error) {
	contract, err := bindFinalizableCrowdsaleImpl(address, caller, nil)
	if err != nil {
		return nil, err
	}
...
func NewFinalizableCrowdsaleImplTransactor(address common.Address, transactor bind.ContractTransactor) (*FinalizableCrowdsaleImplTransactor, error) {
	contract, err := bindFinalizableCrowdsaleImpl(address, nil, transactor)
	if err != nil {
		return nil, err
	}
...
func bindFinalizableCrowdsaleImpl(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(FinalizableCrowdsaleImplABI))
	if err != nil {
		return nil, err
	}
