...
func DeployIndividuallyCappedCrowdsaleImpl(auth *bind.TransactOpts, backend bind.ContractBackend, _rate *big.Int, _wallet common.Address, _token common.Address) (common.Address, *types.Transaction, *IndividuallyCappedCrowdsaleImpl, error) {
	...
	return address, tx, &IndividuallyCappedCrowdsaleImpl{IndividuallyCappedCrowdsaleImplCaller: IndividuallyCappedCrowdsaleImplCaller{contract: contract}, IndividuallyCappedCrowdsaleImplTransactor: IndividuallyCappedCrowdsaleImplTransactor{contract: contract}, IndividuallyCappedCrowdsaleImplFilterer: IndividuallyCappedCrowdsaleImplFilterer{contract: contract}}, nil
}
...
type IndividuallyCappedCrowdsaleImpl struct {
	...
	IndividuallyCappedCrowdsaleImplFilterer   // Log filterer for contract events
}
...
// IndividuallyCappedCrowdsaleImplFilterer is an auto generated log filtering Go binding around an Ethereum contract events.
type IndividuallyCappedCrowdsaleImplFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}
...
func NewIndividuallyCappedCrowdsaleImpl(address common.Address, backend bind.ContractBackend) (*IndividuallyCappedCrowdsaleImpl, error) {
	contract, err := bindIndividuallyCappedCrowdsaleImpl(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &IndividuallyCappedCrowdsaleImpl{IndividuallyCappedCrowdsaleImplCaller: IndividuallyCappedCrowdsaleImplCaller{contract: contract}, IndividuallyCappedCrowdsaleImplTransactor: IndividuallyCappedCrowdsaleImplTransactor{contract: contract}, IndividuallyCappedCrowdsaleImplFilterer: IndividuallyCappedCrowdsaleImplFilterer{contract: contract}}, nil
}
...
func NewIndividuallyCappedCrowdsaleImplCaller(address common.Address, caller bind.ContractCaller) (*IndividuallyCappedCrowdsaleImplCaller, error) {
	contract, err := bindIndividuallyCappedCrowdsaleImpl(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
...
func NewIndividuallyCappedCrowdsaleImplTransactor(address common.Address, transactor bind.ContractTransactor) (*IndividuallyCappedCrowdsaleImplTransactor, error) {
	contract, err := bindIndividuallyCappedCrowdsaleImpl(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
...
// NewIndividuallyCappedCrowdsaleImplFilterer creates a new log filterer instance of IndividuallyCappedCrowdsaleImpl, bound to a specific deployed contract.
func NewIndividuallyCappedCrowdsaleImplFilterer(address common.Address, filterer bind.ContractFilterer) (*IndividuallyCappedCrowdsaleImplFilterer, error) {
	contract, err := bindIndividuallyCappedCrowdsaleImpl(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &IndividuallyCappedCrowdsaleImplFilterer{contract: contract}, nil
}

// bindIndividuallyCappedCrowdsaleImpl binds a generic wrapper to an already deployed contract.
func bindIndividuallyCappedCrowdsaleImpl(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(IndividuallyCappedCrowdsaleImplABI))
	if err != nil {
		return nil, err
	}
...
// IndividuallyCappedCrowdsaleImplOwnershipTransferredIterator is returned from FilterOwnershipTransferred and is used to iterate over the raw logs and unpacked data for OwnershipTransferred events raised by the IndividuallyCappedCrowdsaleImpl contract.
type IndividuallyCappedCrowdsaleImplOwnershipTransferredIterator struct {
	Event *IndividuallyCappedCrowdsaleImplOwnershipTransferred // Event containing the contract specifics and raw log
...
func (it *IndividuallyCappedCrowdsaleImplOwnershipTransferredIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(IndividuallyCappedCrowdsaleImplOwnershipTransferred)
...
func (it *IndividuallyCappedCrowdsaleImplOwnershipTransferredIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *IndividuallyCappedCrowdsaleImplOwnershipTransferredIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// IndividuallyCappedCrowdsaleImplOwnershipTransferred represents a OwnershipTransferred event raised by the IndividuallyCappedCrowdsaleImpl contract.
type IndividuallyCappedCrowdsaleImplOwnershipTransferred struct {
...
func (_IndividuallyCappedCrowdsaleImpl *IndividuallyCappedCrowdsaleImplFilterer) FilterOwnershipTransferred(opts *bind.FilterOpts, previousOwner []common.Address, newOwner []common.Address) (*IndividuallyCappedCrowdsaleImplOwnershipTransferredIterator, error) {
	...
	logs, sub, err := _IndividuallyCappedCrowdsaleImpl.contract.FilterLogs(opts, "OwnershipTransferred", previousOwnerRule, newOwnerRule)
	if err != nil {
		return nil, err
	}
	return &IndividuallyCappedCrowdsaleImplOwnershipTransferredIterator{contract: _IndividuallyCappedCrowdsaleImpl.contract, event: "OwnershipTransferred", logs: logs, sub: sub}, nil
}

// WatchOwnershipTransferred is a free log subscription operation binding the contract event 0x8be0079c531659141344cd1fd0a4f28419497f9722a3daafe3b4186f6b6457e0.
//
// Solidity: event OwnershipTransferred(previousOwner indexed address, newOwner indexed address)
func (_IndividuallyCappedCrowdsaleImpl *IndividuallyCappedCrowdsaleImplFilterer) WatchOwnershipTransferred(opts *bind.WatchOpts, sink chan<- *IndividuallyCappedCrowdsaleImplOwnershipTransferred, previousOwner []common.Address, newOwner []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _IndividuallyCappedCrowdsaleImpl.contract.WatchLogs(opts, "OwnershipTransferred", previousOwnerRule, newOwnerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(IndividuallyCappedCrowdsaleImplOwnershipTransferred)
				if err := _IndividuallyCappedCrowdsaleImpl.contract.UnpackLog(event, "OwnershipTransferred", log); err != nil {
					return err
				}
				event.Raw = log
...
// IndividuallyCappedCrowdsaleImplTokenPurchaseIterator is returned from FilterTokenPurchase and is used to iterate over the raw logs and unpacked data for TokenPurchase events raised by the IndividuallyCappedCrowdsaleImpl contract.
type IndividuallyCappedCrowdsaleImplTokenPurchaseIterator struct {
	Event *IndividuallyCappedCrowdsaleImplTokenPurchase // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *IndividuallyCappedCrowdsaleImplTokenPurchaseIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(IndividuallyCappedCrowdsaleImplTokenPurchase)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *IndividuallyCappedCrowdsaleImplTokenPurchaseIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *IndividuallyCappedCrowdsaleImplTokenPurchaseIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// IndividuallyCappedCrowdsaleImplTokenPurchase represents a TokenPurchase event raised by the IndividuallyCappedCrowdsaleImpl contract.
type IndividuallyCappedCrowdsaleImplTokenPurchase struct {
...
func (_IndividuallyCappedCrowdsaleImpl *IndividuallyCappedCrowdsaleImplFilterer) FilterTokenPurchase(opts *bind.FilterOpts, purchaser []common.Address, beneficiary []common.Address) (*IndividuallyCappedCrowdsaleImplTokenPurchaseIterator, error) {
	...
	logs, sub, err := _IndividuallyCappedCrowdsaleImpl.contract.FilterLogs(opts, "TokenPurchase", purchaserRule, beneficiaryRule)
	if err != nil {
		return nil, err
	}
	return &IndividuallyCappedCrowdsaleImplTokenPurchaseIterator{contract: _IndividuallyCappedCrowdsaleImpl.contract, event: "TokenPurchase", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event TokenPurchase(purchaser indexed address, beneficiary indexed address, value uint256, amount uint256)
func (_IndividuallyCappedCrowdsaleImpl *IndividuallyCappedCrowdsaleImplFilterer) WatchTokenPurchase(opts *bind.WatchOpts, sink chan<- *IndividuallyCappedCrowdsaleImplTokenPurchase, purchaser []common.Address, beneficiary []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _IndividuallyCappedCrowdsaleImpl.contract.WatchLogs(opts, "TokenPurchase", purchaserRule, beneficiaryRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(IndividuallyCappedCrowdsaleImplTokenPurchase)
				if err := _IndividuallyCappedCrowdsaleImpl.contract.UnpackLog(event, "TokenPurchase", log); err != nil {
					return err
				}
				event.Raw = log
