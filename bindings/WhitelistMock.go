...
func DeployWhitelistMock(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *types.Transaction, *WhitelistMock, error) {
	...
	return address, tx, &WhitelistMock{WhitelistMockCaller: WhitelistMockCaller{contract: contract}, WhitelistMockTransactor: WhitelistMockTransactor{contract: contract}, WhitelistMockFilterer: WhitelistMockFilterer{contract: contract}}, nil
}
...
type WhitelistMock struct {
	...
	WhitelistMockFilterer   // Log filterer for contract events
}
...
// WhitelistMockFilterer is an auto generated log filtering Go binding around an Ethereum contract events.
type WhitelistMockFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}
...
func NewWhitelistMock(address common.Address, backend bind.ContractBackend) (*WhitelistMock, error) {
	contract, err := bindWhitelistMock(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &WhitelistMock{WhitelistMockCaller: WhitelistMockCaller{contract: contract}, WhitelistMockTransactor: WhitelistMockTransactor{contract: contract}, WhitelistMockFilterer: WhitelistMockFilterer{contract: contract}}, nil
}
...
func NewWhitelistMockCaller(address common.Address, caller bind.ContractCaller) (*WhitelistMockCaller, error) {
	contract, err := bindWhitelistMock(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
...
func NewWhitelistMockTransactor(address common.Address, transactor bind.ContractTransactor) (*WhitelistMockTransactor, error) {
	contract, err := bindWhitelistMock(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
...
// NewWhitelistMockFilterer creates a new log filterer instance of WhitelistMock, bound to a specific deployed contract.
func NewWhitelistMockFilterer(address common.Address, filterer bind.ContractFilterer) (*WhitelistMockFilterer, error) {
	contract, err := bindWhitelistMock(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &WhitelistMockFilterer{contract: contract}, nil
}

// bindWhitelistMock binds a generic wrapper to an already deployed contract.
func bindWhitelistMock(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(WhitelistMockABI))
	if err != nil {
		return nil, err
	}
...
// WhitelistMockOwnershipTransferredIterator is returned from FilterOwnershipTransferred and is used to iterate over the raw logs and unpacked data for OwnershipTransferred events raised by the WhitelistMock contract.
type WhitelistMockOwnershipTransferredIterator struct {
	Event *WhitelistMockOwnershipTransferred // Event containing the contract specifics and raw log
...
func (it *WhitelistMockOwnershipTransferredIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(WhitelistMockOwnershipTransferred)
...
func (it *WhitelistMockOwnershipTransferredIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *WhitelistMockOwnershipTransferredIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// WhitelistMockOwnershipTransferred represents a OwnershipTransferred event raised by the WhitelistMock contract.
type WhitelistMockOwnershipTransferred struct {
...
func (_WhitelistMock *WhitelistMockFilterer) FilterOwnershipTransferred(opts *bind.FilterOpts, previousOwner []common.Address, newOwner []common.Address) (*WhitelistMockOwnershipTransferredIterator, error) {
	...
	logs, sub, err := _WhitelistMock.contract.FilterLogs(opts, "OwnershipTransferred", previousOwnerRule, newOwnerRule)
	if err != nil {
		return nil, err
	}
	return &WhitelistMockOwnershipTransferredIterator{contract: _WhitelistMock.contract, event: "OwnershipTransferred", logs: logs, sub: sub}, nil
}

// WatchOwnershipTransferred is a free log subscription operation binding the contract event 0x8be0079c531659141344cd1fd0a4f28419497f9722a3daafe3b4186f6b6457e0.
//
// Solidity: event OwnershipTransferred(previousOwner indexed address, newOwner indexed address)
func (_WhitelistMock *WhitelistMockFilterer) WatchOwnershipTransferred(opts *bind.WatchOpts, sink chan<- *WhitelistMockOwnershipTransferred, previousOwner []common.Address, newOwner []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _WhitelistMock.contract.WatchLogs(opts, "OwnershipTransferred", previousOwnerRule, newOwnerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(WhitelistMockOwnershipTransferred)
				if err := _WhitelistMock.contract.UnpackLog(event, "OwnershipTransferred", log); err != nil {
					return err
				}
				event.Raw = log
...
// WhitelistMockWhitelistedAddressAddedIterator is returned from FilterWhitelistedAddressAdded and is used to iterate over the raw logs and unpacked data for WhitelistedAddressAdded events raised by the WhitelistMock contract.
type WhitelistMockWhitelistedAddressAddedIterator struct {
	Event *WhitelistMockWhitelistedAddressAdded // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *WhitelistMockWhitelistedAddressAddedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(WhitelistMockWhitelistedAddressAdded)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *WhitelistMockWhitelistedAddressAddedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *WhitelistMockWhitelistedAddressAddedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// WhitelistMockWhitelistedAddressAdded represents a WhitelistedAddressAdded event raised by the WhitelistMock contract.
type WhitelistMockWhitelistedAddressAdded struct {
	Addr common.Address
	Raw  types.Log // Blockchain specific contextual infos
}
...
func (_WhitelistMock *WhitelistMockFilterer) FilterWhitelistedAddressAdded(opts *bind.FilterOpts) (*WhitelistMockWhitelistedAddressAddedIterator, error) {

	logs, sub, err := _WhitelistMock.contract.FilterLogs(opts, "WhitelistedAddressAdded")
	if err != nil {
		return nil, err
	}
	return &WhitelistMockWhitelistedAddressAddedIterator{contract: _WhitelistMock.contract, event: "WhitelistedAddressAdded", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event WhitelistedAddressAdded(addr address)
func (_WhitelistMock *WhitelistMockFilterer) WatchWhitelistedAddressAdded(opts *bind.WatchOpts, sink chan<- *WhitelistMockWhitelistedAddressAdded) (event.Subscription, error) {

	logs, sub, err := _WhitelistMock.contract.WatchLogs(opts, "WhitelistedAddressAdded")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(WhitelistMockWhitelistedAddressAdded)
				if err := _WhitelistMock.contract.UnpackLog(event, "WhitelistedAddressAdded", log); err != nil {
					return err
				}
				event.Raw = log
...
// WhitelistMockWhitelistedAddressRemovedIterator is returned from FilterWhitelistedAddressRemoved and is used to iterate over the raw logs and unpacked data for WhitelistedAddressRemoved events raised by the WhitelistMock contract.
type WhitelistMockWhitelistedAddressRemovedIterator struct {
	Event *WhitelistMockWhitelistedAddressRemoved // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *WhitelistMockWhitelistedAddressRemovedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(WhitelistMockWhitelistedAddressRemoved)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *WhitelistMockWhitelistedAddressRemovedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *WhitelistMockWhitelistedAddressRemovedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// WhitelistMockWhitelistedAddressRemoved represents a WhitelistedAddressRemoved event raised by the WhitelistMock contract.
type WhitelistMockWhitelistedAddressRemoved struct {
	Addr common.Address
	Raw  types.Log // Blockchain specific contextual infos
}
...
func (_WhitelistMock *WhitelistMockFilterer) FilterWhitelistedAddressRemoved(opts *bind.FilterOpts) (*WhitelistMockWhitelistedAddressRemovedIterator, error) {

	logs, sub, err := _WhitelistMock.contract.FilterLogs(opts, "WhitelistedAddressRemoved")
	if err != nil {
		return nil, err
	}
	return &WhitelistMockWhitelistedAddressRemovedIterator{contract: _WhitelistMock.contract, event: "WhitelistedAddressRemoved", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event WhitelistedAddressRemoved(addr address)
func (_WhitelistMock *WhitelistMockFilterer) WatchWhitelistedAddressRemoved(opts *bind.WatchOpts, sink chan<- *WhitelistMockWhitelistedAddressRemoved) (event.Subscription, error) {

	logs, sub, err := _WhitelistMock.contract.WatchLogs(opts, "WhitelistedAddressRemoved")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(WhitelistMockWhitelistedAddressRemoved)
				if err := _WhitelistMock.contract.UnpackLog(event, "WhitelistedAddressRemoved", log); err != nil {
					return err
				}
				event.Raw = log
