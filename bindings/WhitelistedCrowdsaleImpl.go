...
func DeployWhitelistedCrowdsaleImpl(auth *bind.TransactOpts, backend bind.ContractBackend, _rate *big.Int, _wallet common.Address, _token common.Address) (common.Address, *types.Transaction, *WhitelistedCrowdsaleImpl, error) {
	...
	return address, tx, &WhitelistedCrowdsaleImpl{WhitelistedCrowdsaleImplCaller: WhitelistedCrowdsaleImplCaller{contract: contract}, WhitelistedCrowdsaleImplTransactor: WhitelistedCrowdsaleImplTransactor{contract: contract}, WhitelistedCrowdsaleImplFilterer: WhitelistedCrowdsaleImplFilterer{contract: contract}}, nil
}
...
type WhitelistedCrowdsaleImpl struct {
	...
	WhitelistedCrowdsaleImplFilterer   // Log filterer for contract events
}
...
// WhitelistedCrowdsaleImplFilterer is an auto generated log filtering Go binding around an Ethereum contract events.
type WhitelistedCrowdsaleImplFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}
...
func NewWhitelistedCrowdsaleImpl(address common.Address, backend bind.ContractBackend) (*WhitelistedCrowdsaleImpl, error) {
	contract, err := bindWhitelistedCrowdsaleImpl(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &WhitelistedCrowdsaleImpl{WhitelistedCrowdsaleImplCaller: WhitelistedCrowdsaleImplCaller{contract: contract}, WhitelistedCrowdsaleImplTransactor: WhitelistedCrowdsaleImplTransactor{contract: contract}, WhitelistedCrowdsaleImplFilterer: WhitelistedCrowdsaleImplFilterer{contract: contract}}, nil
}
...
func NewWhitelistedCrowdsaleImplCaller(address common.Address, caller bind.ContractCaller) (*WhitelistedCrowdsaleImplCaller, error) {
	contract, err := bindWhitelistedCrowdsaleImpl(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
...
func NewWhitelistedCrowdsaleImplTransactor(address common.Address, transactor bind.ContractTransactor) (*WhitelistedCrowdsaleImplTransactor, error) {
	contract, err := bindWhitelistedCrowdsaleImpl(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
...
// NewWhitelistedCrowdsaleImplFilterer creates a new log filterer instance of WhitelistedCrowdsaleImpl, bound to a specific deployed contract.
func NewWhitelistedCrowdsaleImplFilterer(address common.Address, filterer bind.ContractFilterer) (*WhitelistedCrowdsaleImplFilterer, error) {
	contract, err := bindWhitelistedCrowdsaleImpl(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &WhitelistedCrowdsaleImplFilterer{contract: contract}, nil
}

// bindWhitelistedCrowdsaleImpl binds a generic wrapper to an already deployed contract.
func bindWhitelistedCrowdsaleImpl(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(WhitelistedCrowdsaleImplABI))
	if err != nil {
		return nil, err
	}
...
// WhitelistedCrowdsaleImplOwnershipTransferredIterator is returned from FilterOwnershipTransferred and is used to iterate over the raw logs and unpacked data for OwnershipTransferred events raised by the WhitelistedCrowdsaleImpl contract.
type WhitelistedCrowdsaleImplOwnershipTransferredIterator struct {
	Event *WhitelistedCrowdsaleImplOwnershipTransferred // Event containing the contract specifics and raw log
...
func (it *WhitelistedCrowdsaleImplOwnershipTransferredIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(WhitelistedCrowdsaleImplOwnershipTransferred)
...
func (it *WhitelistedCrowdsaleImplOwnershipTransferredIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *WhitelistedCrowdsaleImplOwnershipTransferredIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// WhitelistedCrowdsaleImplOwnershipTransferred represents a OwnershipTransferred event raised by the WhitelistedCrowdsaleImpl contract.
type WhitelistedCrowdsaleImplOwnershipTransferred struct {
...
func (_WhitelistedCrowdsaleImpl *WhitelistedCrowdsaleImplFilterer) FilterOwnershipTransferred(opts *bind.FilterOpts, previousOwner []common.Address, newOwner []common.Address) (*WhitelistedCrowdsaleImplOwnershipTransferredIterator, error) {
	...
	logs, sub, err := _WhitelistedCrowdsaleImpl.contract.FilterLogs(opts, "OwnershipTransferred", previousOwnerRule, newOwnerRule)
	if err != nil {
		return nil, err
	}
	return &WhitelistedCrowdsaleImplOwnershipTransferredIterator{contract: _WhitelistedCrowdsaleImpl.contract, event: "OwnershipTransferred", logs: logs, sub: sub}, nil
}

// WatchOwnershipTransferred is a free log subscription operation binding the contract event 0x8be0079c531659141344cd1fd0a4f28419497f9722a3daafe3b4186f6b6457e0.
//
// Solidity: event OwnershipTransferred(previousOwner indexed address, newOwner indexed address)
func (_WhitelistedCrowdsaleImpl *WhitelistedCrowdsaleImplFilterer) WatchOwnershipTransferred(opts *bind.WatchOpts, sink chan<- *WhitelistedCrowdsaleImplOwnershipTransferred, previousOwner []common.Address, newOwner []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _WhitelistedCrowdsaleImpl.contract.WatchLogs(opts, "OwnershipTransferred", previousOwnerRule, newOwnerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(WhitelistedCrowdsaleImplOwnershipTransferred)
				if err := _WhitelistedCrowdsaleImpl.contract.UnpackLog(event, "OwnershipTransferred", log); err != nil {
					return err
				}
				event.Raw = log
...
// WhitelistedCrowdsaleImplTokenPurchaseIterator is returned from FilterTokenPurchase and is used to iterate over the raw logs and unpacked data for TokenPurchase events raised by the WhitelistedCrowdsaleImpl contract.
type WhitelistedCrowdsaleImplTokenPurchaseIterator struct {
	Event *WhitelistedCrowdsaleImplTokenPurchase // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *WhitelistedCrowdsaleImplTokenPurchaseIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(WhitelistedCrowdsaleImplTokenPurchase)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *WhitelistedCrowdsaleImplTokenPurchaseIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *WhitelistedCrowdsaleImplTokenPurchaseIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// WhitelistedCrowdsaleImplTokenPurchase represents a TokenPurchase event raised by the WhitelistedCrowdsaleImpl contract.
type WhitelistedCrowdsaleImplTokenPurchase struct {
...
func (_WhitelistedCrowdsaleImpl *WhitelistedCrowdsaleImplFilterer) FilterTokenPurchase(opts *bind.FilterOpts, purchaser []common.Address, beneficiary []common.Address) (*WhitelistedCrowdsaleImplTokenPurchaseIterator, error) {
	...
	logs, sub, err := _WhitelistedCrowdsaleImpl.contract.FilterLogs(opts, "TokenPurchase", purchaserRule, beneficiaryRule)
	if err != nil {
		return nil, err
	}
	return &WhitelistedCrowdsaleImplTokenPurchaseIterator{contract: _WhitelistedCrowdsaleImpl.contract, event: "TokenPurchase", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event TokenPurchase(purchaser indexed address, beneficiary indexed address, value uint256, amount uint256)
func (_WhitelistedCrowdsaleImpl *WhitelistedCrowdsaleImplFilterer) WatchTokenPurchase(opts *bind.WatchOpts, sink chan<- *WhitelistedCrowdsaleImplTokenPurchase, purchaser []common.Address, beneficiary []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _WhitelistedCrowdsaleImpl.contract.WatchLogs(opts, "TokenPurchase", purchaserRule, beneficiaryRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(WhitelistedCrowdsaleImplTokenPurchase)
				if err := _WhitelistedCrowdsaleImpl.contract.UnpackLog(event, "TokenPurchase", log); err != nil {
					return err
				}
				event.Raw = log
